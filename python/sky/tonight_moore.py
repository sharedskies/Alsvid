...
site_lat = 38.0 + 20.0/60.0 + 40.0/3600.0
site_long = 85.0 + 31.0/60.0 + 44.0/3600.0
zone = timezone('America/Kentucky/Louisville')
...
print("")
print("Twilight for Moore Observatory today")
print("")
