...
# Run the search and return the power spectrum
...
# Generate plot of frequency data with PlotlyJS

trace = scatter(x = frequency, y = power, 
  name = infile, mode = "markers")
...
layout = 
  Layout(
    ...
    title = 
      attr(
        text= string("LS Power from: ",infile),
        y=1.1,
        x=0.5,
        xanchor = "center",
        yanchor = "top"
